...
public class SolicitacaoRequest {
    ...
    private String dataAtividade; // ISO-8601 string
    ...
    public String  getDataAtividade()                 { return dataAtividade; }
    public void    setDataAtividade(String d)         { this.dataAtividade = d; }

...
import { getSolicitacao, registrarAvaliacao, getAvaliacoes } from '../services/api'
...
export default function AvaliacaoPage() {
  ...
  if (!id) return (
    <div style={s.loading}>
      <p>Selecione uma solicitação na lista para registrar uma avaliação.</p>
      <button onClick={() => navigate('/solicitacoes')} style={{ marginTop: 12, padding: '8px 18px', background: '#1e40af', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 13 }}>
        Ver Solicitações
      </button>
    </div>
  )
